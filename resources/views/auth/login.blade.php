    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row mb-3">
                        <a class="col-md-1 col-form-label text-md-end" href="{{ route('social.auth.redirect', ['driver' => 'vkontakte']) }}">
                        ...
                        <a class="col-md-1 col-form-label text-md-end" href="{{ route('social.auth.redirect', ['driver' => 'github']) }}">
